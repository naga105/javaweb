<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="index.jsp" class="flex items-center">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">HighSense</span>
        </a>

        <div class="flex items-center md:order-2">
            <c:choose>
                <c:when test="${sessionScope.account == null}">
                    <button type="button" class="flex mr-3 text-sm bg-gray-800 md:mr-0  " id="user-menu-button"
                ...
                <c:when test="${sessionScope.account != null}">
                    <div class="flex flex-row-reverse mr-4">
                        <a href="Cart?" role="button" class="relative flex">
                            ...
                            <span class="absolute right-0 top-0 rounded-full bg-red-600 w-4 h-4 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">${cartsize}
    </span>
                        </a>
                    </div>
                    <button type="button" class="flex mr-3 text-sm bg-gray-800 md:mr-0  " id="user-menu-button"
                        ...
                        <span class="sr-only">Open user menu</span>
                        <a href=""
                           class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Loged</a>
                    </button>
                </c:when>
            </c:choose>
